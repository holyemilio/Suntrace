...
# NON aprire i file .html (index.html = landing, app.html = simulatore) con
# doppio click: i moduli ES e la geolocalizzazione richiedono http://localhost,
# non funzionano su file://.
cd "$(dirname "$0")"
