...
const STRINGS = {
  it: {
    ...
    'tip-orientation': 'Direzione verso cui guarda la facciata analizzata (0°=Nord, 90°=Est, 180°=Sud, 270°=Ovest). Regolala con lo slider «Rotazione parete».',
    'tip-shading': 'Stima automatica dell\'ostruzione solare (edifici o alberi vicini) in base alla posizione. È un valore euristico, non un rilievo GIS reale.',
  ...
  en: {
    ...
    'tip-orientation': 'Direction the analysed facade faces (0°=North, 90°=East, 180°=South, 270°=West). Adjust it with the “Wall rotation” slider.',
    'tip-shading': 'Automatic estimate of solar obstruction (nearby buildings or trees) based on location. It is a heuristic value, not a real GIS survey.',
