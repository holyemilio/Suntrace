...
const STRINGS = {
  it: {
    ...
    'privacy-s3-body': 'Per funzionare, il tuo browser contatta direttamente questi servizi esterni, ciascuno secondo la propria informativa: OpenStreetMap (mappa), Nominatim (ricerca indirizzi), Overpass (dati sugli edifici), Open-Meteo (clima), Google Fonts (caratteri) e la libreria Leaflet. Questi servizi vedono la richiesta e il tuo indirizzo IP, come per qualunque sito che li utilizza — SunTrace non aggiunge tracciamento oltre a questo.',
  ...
  en: {
    ...
    'privacy-s3-body': 'To work, your browser talks directly to these external services, each under its own policy: OpenStreetMap (map), Nominatim (address search), Overpass (building data), Open-Meteo (climate), Google Fonts (typefaces) and the Leaflet library. These services see the request and your IP address, as with any site that uses them — SunTrace adds no tracking beyond that.',
