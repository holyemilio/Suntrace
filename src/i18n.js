...
const STRINGS = {
  it: {
    ...
    'tip-orientation': 'Direzione verso cui guarda la facciata analizzata, rilevata dal muro dell\'edificio più vicino (dati OpenStreetMap). Puoi correggerla con lo slider «Rotazione parete».',
    'tip-shading': 'Ostruzione solare stimata dagli edifici reali vicini (dati OpenStreetMap): più sono numerosi e alti, minore è l\'irraggiamento sulla facciata.',
  ...
  en: {
    ...
    'tip-orientation': 'Direction the analysed facade faces, detected from the nearest building wall (OpenStreetMap data). You can override it with the “Wall rotation” slider.',
    'tip-shading': 'Solar obstruction estimated from real nearby buildings (OpenStreetMap data): the more and taller they are, the less sunlight reaches the facade.',
